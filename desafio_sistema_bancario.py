...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
        ...
        print("Erro! Valor informado não é válido.")
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
            ...
            print("\n Valor do saque excedeu o permitido.")
            ...
            numero_saques += 1
            print("\n Saque realizado, retire o dinheiro na boca do caixa.")
    else:
...
def criar_usuario(usuarios):
     ...
     endereco = input("Informe seu endereço (logradouro, nro - bairro - ciade/sigla estaldo): ")
